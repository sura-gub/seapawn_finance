    ...
    return(
        <div className='bgcolor'>
            <div className=''>
                ...
                <button style={{textDecoration: 'none'}} className='Btnl bttn' onClick={checkExistingData}>
            ...
            <div className='col-md-6 ee'>
                    <div className='banner_sidebar text-center'>
                        <img src={wall3} alt="" className="ee mpic" />
                ...
                {/* <Link to={`/regis`} style={{textDecoration: 'none'}}> */}
                  <button className="cta" onClick={checkExistingData}>
    <span className="span">Sign Up</span>
    <span className="second">
      <svg width="25px" height="20px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
